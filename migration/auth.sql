...
create unique index if not exists uq_org_feature_org_id_feature_id on organization_feature (org_id, feature_id);
create index if not exists idx_org_feature_org_id on organization_feature (org_id);
